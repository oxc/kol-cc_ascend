...
void handleKingLiberation()
{
	...
	if(get_property("kingLiberated").to_boolean() && (get_property("cc_snapshot") == ""))
	{
		...
		if(get_property("cc_closetCrap").to_boolean())
		{
			boolean[item] toCloset = $items[Blue Plasma Ball, Boiling Broth, Coinspiracy, Cuppa Cruel Tea, Cuppa Royal Tea, Cuppa Sobrie Tea, Cuppa Voraci Tea, Foam Dart, Golden Gum, Golden Gun, Holiday Fun!, Jar Of Swamp Honey, Magical Ice Cube With A Fly In It, Magicberry Tablets, Mysterious Blue Box, Mysterious Green Box, Note From Clancy, Pack Of Alice\'s Army Cards, Personalized Coffee Mug, Personal Massager, Rhinestone, Sack Lunch, Swizzler, Twist Of Lime];
			foreach it in toCloset
			{
				put_closet(item_amount(it), it);
			}
		}

		if(have_display() && get_property("cc_displayCrap").to_boolean())
		{
			boolean[item] toDisplay = $items[Instant Karma, Thwaitgold Ant Statuette, Thwaitgold Bee Statuette, Thwaitgold Bookworm Statuette, Thwaitgold Butterfly Statuette, Thwaitgold Caterpillar Statuette, Thwaitgold Cockroach Statuette, Thwaitgold Dragonfly Statuette, Thwaitgold Firefly Statuette, Thwaitgold Goliath Beetle Statuette, Thwaitgold Grasshopper Statuette, Thwaitgold Maggot Statuette, Thwaitgold Mosquito Statuette, Thwaitgold Moth Statuette, Thwaitgold Nit Statuette, Thwaitgold Praying Mantis Statuette, Thwaitgold Scarab Beetle Statuette, Thwaitgold Scorpion Statuette, Thwaitgold Spider Statuette, Thwaitgold Stag Beetle Statuette, Thwaitgold Termite Statuette, Thwaitgold Wheel Bug Statuette, Thwaitgold Woollybear Statuette];
...
//		visit_url("lair2.php?preaction=key&whichkey=436");
		...
		if(get_property("cc_borrowedTimeOnLiberation").to_boolean() && !get_property("_borrowedTimeUsed").to_boolean())
		{
