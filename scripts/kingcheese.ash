...
void handleKingLiberation()
{
	...
	if(get_property("kingLiberated").to_boolean() && (get_property("cc_snapshot") == ""))
	{
		...
		{
			boolean[item] toCloset = $items[Blue Plasma Ball, Boiling Broth, Coinspiracy, Cuppa Cruel Tea, Cuppa Royal Tea, Cuppa Sobrie Tea, Cuppa Voraci Tea, Foam Dart, Golden Gum, Golden Gun, Holiday Fun!, Jar Of Swamp Honey, Magical Ice Cube With A Fly In It, Magicberry Tablets, Mysterious Green Box, Note From Clancy, Pack Of Alice\'s Army Cards, Personalized Coffee Mug, Personal Massager, Rhinestone, Sack Lunch, Swizzler, Twist Of Lime];
